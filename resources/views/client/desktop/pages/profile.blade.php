                ...
                <div class="dp-sidebar shadow-sm">
                    <div class="dp-sidebar-header">
                        <div class="dp-avatar-box">
                            ...
                            @else
                                <img src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&background=ff4d6d&color=fff" alt="Default Avatar">
                            @endif
                        </div>
                            ...
                            <div class="col-md-4 text-center border-end">
                                <div class="dp-upload-box">
                                    <div class="dp-preview-wrapper">
                                        @if($user->avatar)
                                            <img src="{{ asset('storage/' . $user->avatar) }}" id="mainAvatarPreview" alt="Avatar">
                                        @else
                                            <img src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&background=ff4d6d&color=fff" id="mainAvatarPreview" alt="Default Avatar">
                                        @endif
                                    </div>
                                    ...
                                    <input type="file" name="avatar" id="avatarInputDesktop" hidden accept="image/*">
                            ...
                            <div class="col-md-8 px-4">
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="name" class="form-control dp-input" value="{{ old('name', $user->name) }}" required>
                                    </div>
                                    
                                    <div class="col-md-12">
                                        <label class="dp-label">Địa chỉ Email</label>
                                        <input type="email" class="form-control dp-input" value="{{ $user->email }}" disabled>
                                        <small class="text-muted">Liên hệ quản trị viên để thay đổi email.</small>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="dp-label">Số điện thoại</label>
                                        <input type="text" name="phone_number" class="form-control dp-input" value="{{ old('phone_number', $user->phone_number) }}" placeholder="010-xxxx-xxxx">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="dp-label">Vai trò</label>
                                        <div class="dp-role-badge">
                                            {{ $user->role_id == 1 ? 'Quản trị viên' : 'Khách hàng' }}
                                        </div>
                                    </div>
...
.dp-menu-item:hover i, .dp-menu-item.active i {
    color: #ff4d6d;
}
...
.admin-link { color: #ffc107 !important; }
